...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder>{
     ...
     */
    private List<SiwammBean.Tngou> datas = null;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
      /*  String string=datas.get(position);
        ...
        LogUtils.i("adapter");
        LogUtils.i("adapter"+datas.get(position).getTitle());
        LogUtils.i("adapter"+datas.get(position).getTime());
        LogUtils.i("adapter"+datas.get(position).getImg());
        String title=datas.get(position).getTitle();
        long longTime=datas.get(position).getTime();
        String imageUrl="http://tnfs.tngou.net/image"+datas.get(position).getImg();
     ...
     * @param datas 展示的数据
     */
    public MyRecyclerViewAdapter(List<SiwammBean.Tngou> datas){
        this.datas=datas;
    }
    /**
    ...
    */
    ...
    public  void resetData(List<SiwammBean.Tngou> newdatas){
        datas.clear();
        datas.addAll(newdatas);
    }
    public  void  addDataAtBottom(List<SiwammBean.Tngou> newdatas){
        datas.addAll(newdatas);
    }
}
